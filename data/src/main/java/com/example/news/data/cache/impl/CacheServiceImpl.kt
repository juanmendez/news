package com.example.news.data.cache.impl
...
constructor(
    ...
    override suspend fun insertArticle(article: com.example.news.data.Article): Long {
        return articlesDao.insertArticle(mapper.toEntity(article))
    }

    override suspend fun insertArticles(articles: List<com.example.news.data.Article>): LongArray {
