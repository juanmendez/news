...
struct RepositoryTests {
    ...
    @Test func responseHasNoArticlesVerifyThereAreNoArticles() async throws {
        ...
        let result = await sut.getArticles(query: "", page: 1, pageSize: 10).collect()
    ...
    @Test func responseComesWithError() async throws {
        sut.articlesStreamValues = [
            Resource.loading(),
            Resource.error(error: HttpError.invalidUrl)
        ]
        let result = await sut.getArticles(query: "", page: 1, pageSize: 10).collect()
        #expect(result.first == Resource.loading())
    ...
    @Test func multipleLoadingStatesThenSuccess() async throws {
        ...
        sut.articlesStreamValues = [
            ...
            Resource.loading(item: articles),
            Resource.success(item: articles)
        ]
        let result = await sut.getArticles(query: "Sports", page: 1, pageSize: 10).collect()
    ...
    @Test func errorAfterLoadingWithNoSuccessState() async throws {
        ...
        let result = await sut.getArticles(query: "Breaking News", page: 1, pageSize: 10).collect()
    ...
    @Test func multipleSuccessivePages() async throws {
        ...
        sut.articlesStreamValues = [
            Resource.loading(),
            Resource.success(item: page1Articles)
        ]
        let result1 = await sut.getArticles(query: "Tech", page: 1, pageSize: 10).collect()
        sut.articlesStreamValues = [
            Resource.loading(),
            Resource.success(item: page2Articles)
        ]
        let result2 = await sut.getArticles(query: "Tech", page: 2, pageSize: 10).collect()
    ...
    @Test func differentErrorTypes() async throws {
        ...
        for (index, error) in errors.enumerated() {
            ...
            let result = await sut.getArticles(query: "test\(index)", page: 1, pageSize: 10).collect()
    ...
    @Test func successWithLargeArticleList() async throws {
        ...
        sut.articlesStreamValues = [
            Resource.loading(),
            Resource.success(item: largeList)
        ]
        let result = await sut.getArticles(query: "All News", page: 1, pageSize: 10).collect()
    ...
    @Test func successStreamWithArticlesContainingAllFields() async throws {
        ...
        let result = await sut.getArticles(query: "Technology", page: 1, pageSize: 10).collect()
    ...
    @Test func articlesWithOptionalSourceIdCanBeNil() async throws {
        ...
        sut.articlesStreamValues = [
            Resource.success(item: articlesWithNilSourceId)
        ]
        let result = await sut.getArticles(query: "", page: 1, pageSize: 10).collect()
        if case .success(let articles) = result.last {
